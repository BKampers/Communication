...
public class Messenger {
    ...
    public Messenger(Transporter transporter) {
        if (transporter == null) {
     ...
     */
    public void start() throws bka.communication.ChannelException {
        transporter.open();
     ...
     * @throws bka.communication.ChannelException
     */
    public void stop() throws bka.communication.ChannelException {
